                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4>Kuryelerin Bulunduğu Alan</h4>
                            </div>
                            <div class="card-body">
                                <div id="kabul-edilen-veriler">
                                    <?php
                                    ...
                                    try {
                                        ...
                                        // Kabul edilen siparişleri al
                                        $query = "SELECT * FROM kurye_cagir WHERE durum = 'Kabul Edildi' ORDER BY created_at DESC";
